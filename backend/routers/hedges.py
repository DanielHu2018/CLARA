...
async def get_hedge_proposals():
    return HEDGE_PROPOSALS


@router.get("/analysis")
async def get_hedge_ai_analysis():
    """AI-generated quality analysis for current hedge proposals."""
    return await ai_analysis_service.analyze_hedges(HEDGE_PROPOSALS)
